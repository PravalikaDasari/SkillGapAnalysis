...
public class MatrixExceptionHandler {
   @ExceptionHandler(value = MatrixNotFoundException.class)
	public ResponseEntity<String> exception(MatrixNotFoundException exception) {
		log.error("MatrixNotFoundException-" + exception.getMessage(), exception);
